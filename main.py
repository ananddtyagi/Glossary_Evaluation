...
def run_summary(superclasses, subclass):
    ...
    os.system('python3 '+ termolator_dir + '/mod_make_glossary_part1.py '+  intermediate_file_path +'/'+ subclass +'.file_list  '+ subclass +' .txt '+ termolator_dir)

    for i, super in enumerate(superclasses):
